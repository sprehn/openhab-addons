...
public interface ToastControl extends CapabilityMethods {
    ...
    public final static Collection<String> Capabilities = Collections.unmodifiableCollection(Arrays.asList(Show_Toast,
            Show_Clickable_Toast_App, Show_Clickable_Toast_App_Params, Show_Clickable_Toast_URL));
