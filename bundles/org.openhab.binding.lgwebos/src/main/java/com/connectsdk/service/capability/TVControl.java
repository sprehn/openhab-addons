...
public interface TVControl extends CapabilityMethods {
    ...
    public final static Collection<String> Capabilities = Collections.unmodifiableCollection(Arrays.asList(Channel_Get,
            Channel_Set, Channel_Up, Channel_Down, Channel_List, Channel_Subscribe, Program_Get, Program_List,
            Program_Subscribe, Program_List_Subscribe, Get_3D, Set_3D, Subscribe_3D));
