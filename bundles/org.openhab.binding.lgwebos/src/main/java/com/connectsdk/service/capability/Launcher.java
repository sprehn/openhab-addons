...
public interface Launcher extends CapabilityMethods {
    ...
    public final static Collection<String> Capabilities = Collections
            .unmodifiableCollection(Arrays.asList(Application, Application_Params, Application_Close, Application_List,
                    Browser, Browser_Params, Hulu, Hulu_Params, Netflix, Netflix_Params, YouTube, YouTube_Params,
                    AppStore, AppStore_Params, AppState, AppState_Subscribe, RunningApp, RunningApp_Subscribe));
    ...
    public void launchAppWithInfo(AppInfo appInfo, JsonObject params, ResponseListener<LaunchSession> listener);
