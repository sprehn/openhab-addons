...
public interface MediaPlayer extends CapabilityMethods {
    ...
    public final static Collection<String> Capabilities = Collections
            .unmodifiableCollection(Arrays.asList(Display_Image, Play_Video, Play_Audio, Close, MetaData_Title,
                    MetaData_Description, MetaData_Thumbnail, MetaData_MimeType, MediaInfo_Get, MediaInfo_Subscribe));
     ...
     */
    // @Deprecated
    // public void playMedia(String url, String mimeType, String title, String description, String iconSrc, boolean
    // shouldLoop, LaunchListener listener);
