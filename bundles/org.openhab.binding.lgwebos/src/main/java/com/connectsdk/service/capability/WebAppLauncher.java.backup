...
public interface WebAppLauncher extends CapabilityMethods {
    ...
    public final static Collection<String> Capabilities = Collections
            .unmodifiableCollection(Arrays.asList(Launch, Launch_Params, Message_Send, Message_Receive,
                    Message_Send_JSON, Message_Receive_JSON, Connect, Disconnect, Join, Close, Pin));
